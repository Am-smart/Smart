...
export const authDb = {
  async register(data: { full_name: string; email: string; password?: string; phone?: string; role: string; active?: boolean }): Promise<{ data: User | null, error: any }> {
  ...
  async updateUserRaw(id: string, updates: Partial<User>, sessionId?: string): Promise<{ data: User | null, error: any }> {
