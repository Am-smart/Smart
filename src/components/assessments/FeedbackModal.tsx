                        ...
                        <div className="space-y-6">
                             ...
                             <div className="space-y-4">
                                 {assignment.questions.map((q: QuestionDTO, idx: number) => {
                                    ...
                                    const feedback = (submission).response_feedback?.[q.id];
                                    const isExpanded = !!expandedQuestions[q.id];
                                    return (
                                        <div key={q.id} className="border border-slate-100 rounded-2xl overflow-hidden hover:border-slate-200 transition-colors">
                                            <button
