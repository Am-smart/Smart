...
export const Sidebar: React.FC<SidebarProps> = ({ activePage, onNavigate, isOpen, onClose, items, title }) => {
  return (
    <>
      ...
      {/* Sidebar */}
      <aside className={`fixed left-0 top-0 bottom-0 w-[240px] max-w-[80vw] bg-[#1e293b] text-white p-4 sm:p-6 z-[1001] overflow-y-auto transition-transform duration-300 ${isOpen ? 'translate-x-0' : '-translate-x-full'}`}>
